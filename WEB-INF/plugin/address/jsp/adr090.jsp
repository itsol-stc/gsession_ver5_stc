...
<title>GROUPSESSION <gsmsg:write key="address.adr090.1" /></title>
...
<div class="pageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="address.adr090.1" />
    </li>
    <li>
      <div>
        ...
        <logic:equal name="adr090Form" property="adr080ProcMode" value="<%= edit %>">
          <button type="submit" class="baseBtn" value="<gsmsg:write key="cmn.delete" />" onClick="buttonPush('delete');">
...
<div class="wrapper w80 mrl_auto">
  ...
  <table class="table-left">
    <tr>
      <th class="w20">
        <gsmsg:write key="address.101" /><span class="cl_fontWarn"><gsmsg:write key="cmn.asterisk" /></span>
      </th>
      <td class="w80">
        <html:text maxlength="20" property="adr090atiName" styleClass="wp300" />
      </td>
    </tr>
    <tr>
      <th>
      ...
      <td>
        <textarea name="adr090bikou" rows="5" class="wp550" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="adr090Form" property="adr090bikou" /></textarea>
        <div>
