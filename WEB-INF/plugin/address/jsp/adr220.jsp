...
<div class="wrapper w80 mrl_auto">
  ...
  <table class="table-left">
    <tr>
      ...
      <td class="w75">
        <html:text maxlength="30" property="adr220yksName" styleClass="wp300" />
      </td>
    </tr>
    <tr>
      <th class="w25">
      ...
      <td class="w75">
        <textarea name="adr220bikou" class="wp600" rows="5" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="adr220Form" property="adr220bikou" /></textarea><br>
