...
import static jp.groupsession.v2.adr.adr010.Adr010Const.*;
    ...
    public List<ApiCompanyBaseModel> getCompanyList(Adr010SearchModel model)
        ...
        try {
            ...
            for (int i = 0; rs.next() && i < maxCnt; i++) {
                ...
                Integer acoSid = Integer.valueOf(rs.getInt("ACO_SID"));
                if (companyMap.containsKey(acoSid)) {
                    ...
                    aco.setTdfSid(rs.getInt("COMPANY_TDF_SID"));
                    aco.setTdfName(rs.getString("COMPANY_TDF_NAME"));
