...
/**
 * <br>[機  能] スケジュール リマインダー編集 WEBAPI フォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
@ApiClass(id = "schedule-changeReminder",
plugin = "schedule", name = "リマインダー情報編集",
url = "/api/schedule/changeReminder.do", reqtype = "POST")
public class ApiSchChangeReminderForm extends AbstractApiForm {
    /** スケジュールSID */
    @ApiParam(name = "schSid", viewName = "スケジュールSID")
    private String schSid__;
    /** reminder リマインダー通知時間 */
    @ApiParam(name = "reminder", viewName = "リマインダー通知時間", required = false, confRequired = true)
