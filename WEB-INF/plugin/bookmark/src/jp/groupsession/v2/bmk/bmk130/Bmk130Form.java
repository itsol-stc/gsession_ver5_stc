 ...
 * @author JTS
 */
public class Bmk130Form extends Bmk120Form implements ISelectorUseForm {
    ...
    /** 表示ブックマーク UI */
    private Bmk130BookmarkSelector bmk130ViewBmkListUI__ =
            Bmk130BookmarkSelector.builder()
                .chainLabel(new GsMessageReq("cmn.setting.main.view", null))
                .chainSelect(
                        Select.builder()
                        .chainLabel(new GsMessageReq("cmn.show", null))
                        .chainParameterName(
                                "bmk130ViewBmkList")
                    )
                .build();
     ...
     * @see jp.groupsession.v2.bmk.bmk130.Bmk130Form#bmk130ViewBmkListUI__
     */
