...
/**
 *
 * <br>[機  能] チャットグループ管理のフォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Cht100Form extends Cht020Form {
    ...
    /** ソートキー */
    private int cht100SortKey__ = GSConstChat.CHAT_SORT_ADATE;
    /** オーダーキー */
    private int cht100OrderKey__ = GSConstChat.CHAT_ORDER_DESC;
    ...
    /** ソートキー */
    private int svCht100SortKey__ = GSConstChat.CHAT_SORT_ADATE;
    /** オーダーキー */
    private int svCht100OrderKey__ = GSConstChat.CHAT_ORDER_DESC;
     ...
     */
    public ActionErrors validateCht100Edit(
            RequestModel reqMdl, Connection con, Cht100Form form) throws SQLException {
        ActionErrors errors = new ActionErrors();
        GsMessage gsMsg = new GsMessage(reqMdl);
        // グループ
        if (!ChatValidate.validateIsExitChatGroup(cgiSid__, con)) {
            ActionMessage msg
     ...
     */
    public ActionErrors validateCht100(
            HttpServletRequest req, Connection con, boolean isSv, RequestModel reqMdl)
        ...
        // 検索パラメータ
         String keyword = this.getCht100Keyword();
         int andOr = this.getCht100AndOr();
         int groupId = this.getCht100GroupId();
         int groupName = this.getCht100GroupName();
         int groupInfo = this.getCht100GroupInfo();
         int category = this.getCht100Category();
         int statusKbn = this.getCht100StatusKbn();
         int selectUser = this.getCht100SelectUser();
         int selectGroup = this.getCht100SelectGroup();
         int adminMember = this.getCht100AdminMember();
         int generalMember = this.getCht100GeneralMember();
         int createYearFr = this.getCht100CreateYearFr();
         int createMonthFr = this.getCht100CreateMonthFr();
         int createDayFr = this.getCht100CreateDayFr();
         int createYearTo = this.getCht100CreateYearTo();
         int createMonthTo = this.getCht100CreateMonthTo();
         int createDayTo = this.getCht100CreateDayTo();
         String createDateFr = this.getCht100CreateDateFr();
         String createDateTo = this.getCht100CreateDateTo();
         int updateYearFr = this.getCht100UpdateYearFr();
         int updateMonthFr = this.getCht100UpdateMonthFr();
         int updateDayFr = this.getCht100UpdateDayFr();
         int updateYearTo = this.getCht100UpdateYearTo();
         int updateMonthTo = this.getCht100UpdateMonthTo();
         int updateDayTo = this.getCht100UpdateDayTo();
         String updateDateFr = this.getCht100UpdateDateFr();
         String updateDateTo = this.getCht100UpdateDateTo();
         int sortKey = this.getCht100SortKey();
         int orderKey = this.getCht100OrderKey();

        // 保存用パラメータ使用の場合
        if (isSv) {
             keyword = this.getSvCht100Keyword();
             andOr = this.getSvCht100AndOr();
             groupId = this.getSvCht100GroupId();
             groupName = this.getSvCht100GroupName();
             groupInfo = this.getSvCht100GroupInfo();
             category = this.getSvCht100Category();
             statusKbn = this.getSvCht100StatusKbn();
             selectGroup = this.getSvCht100SelectGroup();
             selectUser = this.getSvCht100SelectUser();
             adminMember = this.getSvCht100AdminMember();
             generalMember = this.getSvCht100GeneralMember();
             createYearFr = this.getSvCht100CreateYearFr();
             createMonthFr = this.getSvCht100CreateMonthFr();
             createDayFr = this.getSvCht100CreateDayFr();
             createMonthTo = this.getSvCht100CreateMonthTo();
             createDayTo = this.getSvCht100CreateDayTo();
             createDateFr = this.getSvCht100CreateDateFr();
             createDateTo = this.getSvCht100CreateDateTo();
             updateYearFr = this.getSvCht100UpdateYearFr();
             updateMonthFr = this.getSvCht100UpdateMonthFr();
             updateDayFr = this.getSvCht100UpdateDayFr();
             updateYearTo = this.getSvCht100UpdateYearTo();
             updateMonthTo = this.getSvCht100UpdateMonthTo();
             updateDayTo = this.getSvCht100UpdateDayTo();
             sortKey = this.getSvCht100SortKey();
             orderKey = this.getSvCht100OrderKey();
        }
        ...
        errors = ChatValidate.validateCmnFieldText(
                ...
                keyword,
                "keyword",
                GSConstChat.MAX_LENGTH_KEYWORD,
                false);

        // 検索条件
        if (!StringUtil.isNullZeroStringSpace(keyword)) {
            if (groupId == GSConstChat.SEARCH_GROUPID_OUT
                    && groupName == GSConstChat.SEARCH_GROUPID_OUT
                    && groupInfo == GSConstChat.SEARCH_GROUPINFO_OUT) {
        ...
        // 検索And Or
        if (andOr != GSConstChat.KEYWORDKBN_AND
                && andOr != GSConstChat.KEYWORDKBN_OR) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("cmn.keyword"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "keywordAndOr";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
        // グループID
        if (groupId != GSConstChat.SEARCH_GROUPID_IN
                && groupId != GSConstChat.SEARCH_GROUPID_OUT) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
        ...
        // グループ名
        if (groupName != GSConstChat.SEARCH_GROUPID_IN
                && groupName != GSConstChat.SEARCH_GROUPID_OUT) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
        ...
        // 備考
        if (groupInfo != GSConstChat.SEARCH_GROUPINFO_IN
                && groupInfo != GSConstChat.SEARCH_GROUPINFO_OUT) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
        ...
        // 状態区分
        if (statusKbn != GSConstChat.SEARCH_STATUSKBN_ALL
                && statusKbn != GSConstChat.SEARCH_STATUSKBN_NOT_ARCHIVE
                && statusKbn != GSConstChat.SEARCH_STATUSKBN_ARCHIVE_ONLY) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("anp.state") + gsMsg.getMessage("tcd.tcd070.03"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "groupId";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
        ...
        // グループ
        boolean isGroup = selectGroup > -1;
        if (isGroup && !GSValidateUser.existGroup(selectGroup, con)) {
                ActionMessage msg = new ActionMessage("error.input.format.file",
                        gsMsg.getMessage(req, "cmn.member"),
                        gsMsg.getMessage(req, "cmn.group.sid"));
                errors.add("error.input.format.file", msg);
                isGroup = false;
        }
        // ユーザ
        if (isGroup && selectUser > -1) {
            CmnUsrmDao cuDao = new CmnUsrmDao(con);
            if (!cuDao.isExistUser(selectUser)) {
                ActionMessage msg = new ActionMessage("error.input.format.file",
        ...
        // 管理者一般
        if (adminMember != GSConstChat.SEARCH_GROUPADMIN_IN
                && adminMember != GSConstChat.SEARCH_GROUPADMIN_OUT) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("cmn.admin"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "groupId";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
        if (generalMember != GSConstChat.SEARCH_GENERALUSER_IN
                && generalMember != GSConstChat.SEARCH_GENERALUSER_OUT) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("cht.cht100.05"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "groupId";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
        ...
        // メンバー条件
        if (selectGroup > -1 || selectUser > -1) {
            if (adminMember == GSConstChat.SEARCH_GROUPADMIN_OUT
                    && generalMember == GSConstChat.SEARCH_GENERALUSER_OUT) {
                ActionMessage msg = new ActionMessage("error.input.required.text",
                        gsMsg.getMessage("cmn.member"));
                errors.add("error.input.required.text", msg);
            }
        }

        // 作成日時
        String createFrom = gsMsg.getMessage(req, "cht.cht100.06");
        String creatTo = gsMsg.getMessage(req, "cht.cht100.07");
        String lastFrom = gsMsg.getMessage(req, "cht.cht100.08");
        String lastTo = gsMsg.getMessage(req, "cht.cht100.09");
        ...
        if (!StringUtil.isNullZeroString(createDateFr)) {
            ActionErrors createDateError;
            if (isSv) {
                createDateError = dateBiz.setYmdParam(this, "svCht100CreateDateFr",
                        "svCht100CreateYearFr", "svCht100CreateMonthFr",
                        "svCht100CreateDayFr", gsMsg.getMessage("cht.cht100.06"));

            } else {
                createDateError = dateBiz.setYmdParam(this, "cht100CreateDateFr",
                        "cht100CreateYearFr", "cht100CreateMonthFr",
                        "cht100CreateDayFr", gsMsg.getMessage("cht.cht100.06"));
                createYearFr = this.getCht100CreateYearFr();
                createMonthFr = this.getCht100CreateMonthFr();
                createDayFr = this.getCht100CreateDayFr();
            }
            
            if (!createDateError.isEmpty()) {
                errors.add(createDateError);
            }
        ...
        if (!StringUtil.isNullZeroString(createDateTo)) {
            ActionErrors createDateError;
            if (isSv) {
                createDateError = dateBiz.setYmdParam(this, "svCht100CreateDateTo",
                        "svCht100CreateYearTo", "svCht100CreateMonthTo",
                        "svCht100CreateDayTo", gsMsg.getMessage("cht.cht100.07"));
            } else {
                createDateError = dateBiz.setYmdParam(this, "cht100CreateDateTo",
                        "cht100CreateYearTo", "cht100CreateMonthTo",
                        "cht100CreateDayTo", gsMsg.getMessage("cht.cht100.07"));
            ...
            if (createDateError.isEmpty()) {
                createYearTo = this.getCht100CreateYearTo();
                createMonthTo = this.getCht100CreateMonthTo();
                createDayTo = this.getCht100CreateDayTo();
                inputTo = true;
            }
        }
        ...
        if (inputFrom && inputTo && errCount == errors.size()) {
            ...
            frDate.setDate(createYearFr, createMonthFr, createDayFr);
            toDate.setDate(createYearTo, createMonthTo, createDayTo);

            errors = ChatValidate.checkDateRange(errors, createFrom, creatTo, frDate, toDate);
        }
        ...
        if (!StringUtil.isNullZeroString(updateDateFr)) {
            ActionErrors updateDateError;
            if (isSv) {
                updateDateError = dateBiz.setYmdParam(this, "svCht100UpdateDateFr",
                        "svCht100UpdateYearFr", "svCht100UpdateMonthFr",
                        "svCht100UpdateDayFr", gsMsg.getMessage("cht.cht100.08"));
            } else {
                updateDateError = dateBiz.setYmdParam(this, "cht100UpdateDateFr",
                        "cht100UpdateYearFr", "cht100UpdateMonthFr",
                        "cht100UpdateDayFr", gsMsg.getMessage("cht.cht100.08"));
            }
            
            if (!updateDateError.isEmpty()) {
                errors.add(updateDateError);
            }
            
            if (updateDateError.isEmpty()) {
                updateYearFr = this.getCht100UpdateYearFr();
                updateMonthFr = this.getCht100UpdateMonthFr();
                updateDayFr = this.getCht100UpdateDayFr();
                inputFrom = true;
            }
        }
        
        if (!StringUtil.isNullZeroString(updateDateTo)) {
            ActionErrors updateDateError;
            if (isSv) {
                updateDateError = dateBiz.setYmdParam(this, "svCht100UpdateDateTo",
                        "svCht100UpdateYearTo", "svCht100UpdateMonthTo",
                        "svCht100UpdateDayTo", gsMsg.getMessage("cht.cht100.09"));
            } else {
                updateDateError = dateBiz.setYmdParam(this, "cht100UpdateDateTo",
                        "cht100UpdateYearTo", "cht100UpdateMonthTo",
                        "cht100UpdateDayTo", gsMsg.getMessage("cht.cht100.09"));
            }
            ...
            if (updateDateError.isEmpty()) {
                updateYearTo = this.getCht100UpdateYearTo();
                updateMonthTo = this.getCht100UpdateMonthTo();
                updateDayTo = this.getCht100UpdateDayTo();
                inputTo = true;
            }
        }
        ...
        if (inputFrom && inputTo && errCount == errors.size()) {
            ...
            UDate frDate = UDate.getInstance(time);
            UDate toDate = UDate.getInstance(time);
            frDate.setDate(updateYearFr, updateMonthFr, updateDayFr);
            toDate.setDate(updateYearTo, updateMonthTo, updateDayTo);

            errors = ChatValidate.checkDateRange(errors, lastFrom, lastTo, frDate, toDate);
        }

        // ソートキー
        if (sortKey != GSConstChat.CHAT_SORT_GRPID
                && sortKey != GSConstChat.CHAT_SORT_GRPNAME
                && sortKey != GSConstChat.CHAT_SORT_ADATE
                && sortKey != GSConstChat.CHAT_SORT_EDATE) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("cmn.sortkey"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "groupId";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
        // オーダーキー
        if (orderKey != GSConstChat.CHAT_ORDER_ASC
                && orderKey != GSConstChat.CHAT_ORDER_DESC) {
                   ActionMessage msg =  new ActionMessage("error.input.format.file",
                           gsMsg.getMessage("cmn.order.asc") + gsMsg.getMessage("cmn.order.desc"),
                           gsMsg.getMessage("main.man340.10"));
                   String eprefix = "groupId";
                   StrutsUtil.addMessage(errors, msg, eprefix);
        }
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100InitFlg__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100Keyword__
     */
     ...
     * @return cht100AndOr
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100AndOr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GroupId__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GroupName__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GroupInfo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100Category__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100StatusKbn__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100SelectGroup__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100SelectUser__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100AdminMember__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GeneralMember__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateYearFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateMonthFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateDayFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateYearTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateMonthTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CreateDayTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateYearFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateMonthFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateDayFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateYearTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateMonthTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UpdateDayTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100SortKey__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100OrderKey__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100Keyword__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100AndOr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100GroupId__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100GroupName__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100GroupInfo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100Category__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100StatusKbn__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100SelectGroup__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100SelectUser__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100AdminMember__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100GeneralMember__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateYearFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateMonthFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateDayFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateYearTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateMonthTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100CreateDayTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateYearFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateMonthFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateDayFr__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateYearTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateMonthTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100UpdateDayTo__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100PageTop__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100PageBottom__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100CategoryList__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GroupList__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100UserList__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100GrpDataList__
     */
     ...
     * <p>pageList を取得します。
     * @return pageList
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#pageList__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100SortKey__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#svCht100OrderKey__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100SearchFlg__
     */
     ...
     * <p>cgiSid を取得します。
     * @return cgiSid
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cgiSid__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100ProcMode__
     */
     ...
     * @see jp.groupsession.v2.cht.cht100.Cht100Form#cht100OldYear__
     */
