...
<script src="../common/js/cmn140.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('backPsMenu');">
...
<div class="wrapper w80 mrl_auto mt20">
  ...
  <table class="table-left">
    <tr>
      ...
      <td class="w70">
        <ui:sortingselector name="cmn140Form" property="cmn140viewMenuUI" styleClass="hp200"
        onchange="" />
      </td>
    </tr>
  </table>
