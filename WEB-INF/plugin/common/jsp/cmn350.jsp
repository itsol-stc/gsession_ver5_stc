...
<body>
  <html:form action="/common/cmn350">
      ...
      <img src="../common/images/original/icon_ptool_32.png" alt="<gsmsg:write key="cmn.preferences2" />" class="header_pluginImg">
        ...
        <li>
          <div>
            ...
            <button type="button" class="baseBtn" value="back" onClick="buttonPush('cmn350Back');">
    ...
    <div class="wrapper w80 mrl_auto">
          ...
          <td class="w75">
            ...
            <div>
              <span class="verAlignMid">
                <html:radio styleId="cmn320RokuyoDsp_01" name="cmn350Form" property="cmn350RokuyoDsp" value="<%= String.valueOf(GSConst.DSP_NOT) %>" />
                <label for="cmn320RokuyoDsp_01"><gsmsg:write key="cmn.dont.show" /></label>
                <html:radio styleId="cmn320RokuyoDsp_02" name="cmn350Form" property="cmn350RokuyoDsp" value="<%= String.valueOf(GSConst.DSP_OK) %>" styleClass="ml10" />
      ...
      <div class="footerBtn_block">
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('cmn350Back');">
