...
<logic:empty name="UsrGrpSelDialogForm" property="resultFlg">
        ...
        <logic:notEmpty name="usrgrpsel" property="allList">
          ...
          <logic:iterate id="user" name="usrgrpsel" property="allList" indexId="idx" type="UsrLabelValueBean">
            <tr class="js_listHover cursor_p">
              <%
                checked = "";
                if (Objects.equals(usrgrpsel.getSelectedSingle(), user.getValue())) {
                  checked = "bgC_select " ;
                }
                String selectEv = "";
...
<logic:notEmpty name="UsrGrpSelDialogForm" property="resultFlg">
