 ...
 * @author JTS
 */
public class UsrGrpSelDialogAction extends AbstractGsAction {
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        UsrGrpSelDialogForm thisForm = (UsrGrpSelDialogForm) form;

        thisForm.getUsrgrpsel().dspInit(getRequestModel(req), con);
