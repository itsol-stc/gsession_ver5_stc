...
/**
 * <br>[機  能] サイボウズLiveデータ移行 イベントインポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man460Biz extends Man440Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Man460Biz.class);
     ...
     */
    public Man460Biz(RequestModel reqMdl) {
        super(reqMdl);
    }
     ...
     */
    public void setInitData(Man460ParamModel paramMdl,
                            Connection con,
                            String tempDir)
    throws SQLException, IOToolsException {
        ...
        paramMdl.setMan460FileLabelList(fileLblList);

        paramMdl.setMan460grpName(getGroupName(paramMdl, con));
    }
}
