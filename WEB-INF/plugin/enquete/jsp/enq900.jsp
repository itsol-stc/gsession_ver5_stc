...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('enq900back');">
...
<div class="wrapper w80 mrl_auto">
  <div class="settingList">
    <dl>
      <dt onClick="buttonPush('enq900makeUser');">
        <span class="settingList_title"><gsmsg:write key="cmn.preferences" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="enq.enq900.02"/></div>
      </dd>
    </dl>
    <dl>
      <dt onClick="buttonPush('enq900syurui');">
        <span class="settingList_title"><gsmsg:write key="enq.enq900.03"/></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="enq.enq900.04"/></div>
      </dd>
    </dl>
    <dl>
      <dt onClick="buttonPush('enq900mngEnq');">
        <span class="settingList_title"><gsmsg:write key="enq.enq900.13"/></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="enq.enq900.14"/></div>
      </dd>
    </dl>
    <dl>
      <dt onClick="buttonPush('enq900dsp');">
        <span class="settingList_title"><gsmsg:write key="enq.enq900.05"/></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="enq.enq900.06"/></div>
      </dd>
    </dl>
  </div>
</div>
