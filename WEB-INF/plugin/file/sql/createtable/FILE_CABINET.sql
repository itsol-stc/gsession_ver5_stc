 create table FILE_CABINET
   (
     ...
     FCB_ERRL         integer     not null,
     FCB_SORT_FOLDER  integer     not null,
     FCB_SORT_FOLDER1 integer,
     FCB_SORT_FOLDER2 integer,
     FCB_SORT_FOLDER3 integer,
     FCB_JKBN         integer     not null,
     primary key (FCB_SID)
   );
