...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="main.holiday.setting" /></span><gsmsg:write key="main.man029kn.2" />
    </li>
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.run" />" class="baseBtn" onClick="buttonPush('doImport2');">
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('back_holImp');">
    ...
    <tr>
      ...
      <td class="w75">
        <a href="../main/man028kn.do?CMD=downLoad">
         <bean:write name="man028knForm" property="man028knFileName" />
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td class="w75">
        <bean:write name="man028knForm" property="impDataCnt" /><gsmsg:write key="cmn.number" />
      </td>
    </tr>
    <tr>
      <th class="w25">
