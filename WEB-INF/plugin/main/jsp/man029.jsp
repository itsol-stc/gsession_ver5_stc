...
<title>GROUPSESSION <gsmsg:write key="main.man029.1" /></title>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="main.holiday.template" /></span><gsmsg:write key="cmn.import" />
    </li>
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.import" />" class="baseBtn" onClick="buttonPush('import_kakunin');">
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('backHolTmp');">
    ...
    <tr>
      ...
      <td>
        <div class="verAlignMid">
          <html:checkbox name="man029Form" property="man029updateFlg" value="1" styleId="updateFlg" /><label for="updateFlg"><gsmsg:write key="cmn.holidays.same.date.override" /></label>
        </div>
      </td>
    </tr>
  </table>
