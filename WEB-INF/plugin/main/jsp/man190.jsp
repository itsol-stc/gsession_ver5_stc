...
<title>GROUPSESSION <gsmsg:write key="main.manualdelete.login.history" /></title>
</head>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.ok" />" class="baseBtn" onClick="buttonPush('syudo_del_kakunin');">
...
<table class="table-left">
    <tr>
      ...
      <td class="w75">
        <div class="mb5">
          <gsmsg:write key="main.man190.2" />
        </div>
        <html:select property="man190Year" styleClass="wp100">
          <html:optionsCollection name="man190Form" property="man190YearLabelList" value="value" label="label" />
        </html:select>
        <html:select property="man190Month" styleClass="wp100">
