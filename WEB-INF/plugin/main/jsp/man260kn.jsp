...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="main.man260kn.1" />
    </li>
    <li>
      <div>
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('backMan260');">
...
<table class="table-left">
    ...
    <logic:equal name="man260knForm" property="man260BatchKbn" value="1">
      ...
      <b><gsmsg:write key="cmn.year" arg0="<%= yr %>" /> <gsmsg:write key="cmn.months" arg0="<%= month %>" /></b> <gsmsg:write key="main.man260kn.2" />
      </td>
    </logic:equal>
    <logic:notEqual name="man260knForm" property="man260BatchKbn" value="1">
      <td class="w75"><gsmsg:write key="main.man260kn.3" /></td>
    </logic:notEqual>
    </tr>
  </table>
