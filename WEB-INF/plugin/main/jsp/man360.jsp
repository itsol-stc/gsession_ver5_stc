...
<script src="../main/js/man360.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="kanriPageTitle">
  <ul>
    ...
    <li>
      <div>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.ok" />" onClick="buttonPush2('man360edit');">
          <img class="btn_classicImg-display" src="../common/images/classic/icon_ok.png" alt="<gsmsg:write key="cmn.ok" />">
          <img class="btn_originalImg-display" src="../common/images/original/icon_check.png" alt="<gsmsg:write key="cmn.ok" />">
          <gsmsg:write key="cmn.ok" />
        </button>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush2('man360back');">
...
<div class="wrapper">
    ...
    <tr>
      ...
      <td class="w80">
        <div class="verAlignMid">
          <html:radio styleId="layout_0" name="man360Form" property="man360layout" value="<%= String.valueOf(jp.groupsession.v2.man.GSConstMain.MANSCREEN_LAYOUT_DEFAULT) %>" onclick="chgDefaultArea();" />
          <label for="layout_0"><gsmsg:write key="cmn.default" /></label>
          <html:radio styleId="layout_1" styleClass="ml10" name="man360Form" property="man360layout" value="<%= String.valueOf(jp.groupsession.v2.man.GSConstMain.MANSCREEN_LAYOUT_CUSTOM) %>" onclick="chgDefaultArea();" />
  ...
  <div id="checkarea">
    <div class="flo_l verAlignMid">
      <html:checkbox styleId="topId" name="man360Form" property="man360area3" value="1" onclick="chgArea('topId', 'Top');" />
      <label for="topId"><gsmsg:write key="ptl.ptl060.2" /></label>
      <html:checkbox styleId="leftId" styleClass="ml10" name="man360Form" property="man360area1" value="1" onclick="chgArea('leftId', 'Left');" />
      <label for="leftId"><gsmsg:write key="cmn.left" /></label>
      <html:checkbox styleId="centerId" styleClass="ml10" name="man360Form" property="man360area5" value="1" onclick="chgArea('centerId', 'Center');" />
      <label for="centerId"><gsmsg:write key="ptl.ptl060.3" /></label>
      <html:checkbox styleId="rightId" styleClass="ml10" name="man360Form" property="man360area2" value="1" onclick="chgArea('rightId', 'Right');" />
      <label for="rightId"><gsmsg:write key="cmn.right" /></label>
      <html:checkbox styleId="bottomId" styleClass="ml10" name="man360Form" property="man360area4" value="1" onclick="chgArea('bottomId', 'Bottom');" />
