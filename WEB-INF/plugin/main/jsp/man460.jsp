...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="main.man460.1" />
    </li>
    <li>
      <button type="button" value="<gsmsg:write key="cmn.import" />" class="baseBtn" onClick="buttonPush('Man460_Import');">
      ...
      <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('Man460_Back');">
...
<div class="wrapper w80 mrl_auto">
  ...
  <div class="p10 bor1 bgC_cybozuAlert">
    <table class="w100">
      ...
      <tr>
        <td class="txt_t">●</td>
        <td class="w100 txt_l"><gsmsg:write key="main.man460.6" /></td>
      </tr>
      <tr>
        <td class="txt_t">●</td>
        <td class="w100 txt_l"><gsmsg:write key="main.man460.7" /></td>
      </tr>
      <tr>
        <td class="txt_t">●</td>
        <td class="w100 txt_l"><gsmsg:write key="main.man460.8" /></td>
      </tr>
      <tr>
        <td class="txt_t">●</td>
        <td class="w100 txt_l"><gsmsg:write key="main.man460.9" /></td>
      </tr>
      <tr>
        <td class="txt_t">●</td>
        <td class="w100 txt_l"><gsmsg:write key="main.man460.10" /></td>
      </tr>
    </table>
  </div>
  <table class="table-left w100">
    <tr>
      <th class="w20 no_w">
        <gsmsg:write key="main.man460.2" /><span class="cl_fontWarn"><gsmsg:write key="cmn.comments" /></span>
      </th>
      <td class="w80">
        <div>
          <button type="button" class="baseBtn ml0" value="<gsmsg:write key="cmn.attached" />" onClick="opnTemp('man460selectFiles', '<%=GSConstCommon.CMN110MODE_FILE_TANITU%>', '<%=GSConstMain.PLUGIN_ID_MAIN%>', 'man460');">
        ...
        <html:select property="man460selectFiles" styleClass="wp200 ml0" size="1">
    ...
    <tr>
      <th class="w20 no_w">
        <gsmsg:write key="main.man460.3" />
      </th>
      <td class="w80">
        <bean:write name="man460Form" property="man460grpName" />
      </td>
    </tr>
  </table>
