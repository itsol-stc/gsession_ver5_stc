...
<ntp:conf_hidden name="ntp084knForm"/>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="ntp.1" /></span><gsmsg:write key="cmn.import" /><gsmsg:write key="cmn.check" />
    </li>
    <li>
      <div>
...
<gsmsg:write key="main.man028kn.3" />
  ...
  <table class="table-left">
    <tr>
      <th class="w25">
        <gsmsg:write key="main.src.34" /><gsmsg:write key="cmn.name3" />
      </th>
      <td class="w75">
        <a href="../nippou/ntp084kn.do?CMD=downLoad">
          <bean:write name="ntp084knForm" property="ntp084knFileName" />
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <bean:write name="ntp084knForm" property="impDataCnt" /><gsmsg:write key="cmn.number" />
      </td>
    </tr>
  </table>
