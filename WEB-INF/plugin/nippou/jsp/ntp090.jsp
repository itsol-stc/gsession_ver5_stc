...
<ntp:conf_hidden name="ntp090Form"/>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ntp090back');">
...
<div class="wrapper w80 mrl_auto">
  <div class="settingList">
    <dl>
      <dt onClick="return buttonPush('listdspset');">
        <span class="settingList_title"><gsmsg:write key="cmn.display.settings" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="ntp.107" /></div>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        <div class="settingList_text"><gsmsg:write key="ntp.105" /></div>
      </dd>
    </dl>
  </div>
</div>
