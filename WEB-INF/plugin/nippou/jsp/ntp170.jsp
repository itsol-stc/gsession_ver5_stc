...
<script src="../nippou/js/ntp170.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="pageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="ntp.3" /><gsmsg:write key="cmn.list" />
    </li>
    <li>
      ...
      <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="return buttonPush2('backNtp170');">
...
<div class="wrapper w80 mrl_auto">
  <div class="txt_l">
    <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.up" />" onClick="buttonPush2('upBunruiData');">
      <gsmsg:write key="cmn.up" />
    </button>
    <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.down" />" onClick="buttonPush2('downBunruiData');">
  ...
  <table class="table-top w100">
    <tr>
      ...
      <th class="w15 no_w">
        <gsmsg:write key="ntp.117" />
      </th>
      <th class="w80">
        <gsmsg:write key="ntp.3" /><gsmsg:write key="cmn.name3" />
      </th>
    </tr>
    <logic:notEmpty name="ntp170Form" property="ntp170KtbunruiList">
      <logic:iterate id="bunruiMdl" name="ntp170Form" property="ntp170KtbunruiList" indexId="idx">
        ...
        <tr class="js_listHover cursor_p" data-sid="<bean:write name="bunruiMdl" property="ktbSid" />">
          ...
          <td class="w15 js_listClick cl_linkDef">
            <bean:write name="bunruiMdl" property="ktbCode" />
          </td>
          <td class="w80 js_listClick cl_linkDef">
            <bean:write name="bunruiMdl" property="ktbName" />
          </td>
        </tr>
      </logic:iterate>
    </logic:notEmpty>
