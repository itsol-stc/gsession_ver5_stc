...
<script src="../nippou/js/ntp180.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="pageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="ntp.121" /><gsmsg:write key="cmn.list" />
    </li>
    <li>
      ...
      <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="return buttonPush2('backNtp180');">
...
<div class="wrapper w80 mrl_auto">
  <div class="txt_l">
    <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.up" />" onClick="buttonPush2('upHouhouData');">
      <gsmsg:write key="cmn.up" />
    </button>
    <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.down" />" onClick="buttonPush2('downHouhouData');">
  ...
  <table class="table-top w100">
    <tr>
      ...
      <th class="w15 no_w">
        <gsmsg:write key="ntp.118" />
      </th>
      <th class="w80">
        <gsmsg:write key="ntp.121" /><gsmsg:write key="cmn.name3" />
      </th>
    </tr>
    <logic:notEmpty name="ntp180Form" property="ntp180KthouhouList">
      <logic:iterate id="houhouMdl" name="ntp180Form" property="ntp180KthouhouList" indexId="idx">
        ...
        <tr class="js_listHover cursor_p" data-sid="<bean:write name="houhouMdl" property="kthSid" />">
          ...
          <td class="w15 js_listClick cl_linkDef">
            <bean:write name="houhouMdl" property="kthCode" />
          </td>
          <td class="w80 js_listClick cl_linkDef">
            <bean:write name="houhouMdl" property="kthName" />
          </td>
        </tr>
      </logic:iterate>
    </logic:notEmpty>
