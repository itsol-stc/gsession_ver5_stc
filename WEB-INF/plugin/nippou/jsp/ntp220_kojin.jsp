...
<table class="wp250 mb10 sideTop-font">
  <tr>
    <td class="w50 cursor_p bgC_lightGray bor1 txt_c searchMenu_top searchMenu_top" onclick="changeMode(0);">
...
<div class="w100 mt10 txt_l">
  ...
  <logic:notEmpty name="ntp220Form" property="ntp220UserLabel" scope="request">
    <html:select property="ntp220GroupSid" styleClass="ml5 wp120" onchange="changeShukeiGroupCombo();">
    ...
    <span class="ml20"><gsmsg:write key="cmn.user" />:</span>
    <html:select property="ntp220SelectUsrSid"  styleClass="wp120 ml5" onchange="changeUsrCmb();" >
  ...
  <logic:empty name="ntp220Form" property="ntp220UserLabel" scope="request">
    <html:select property="ntp220GroupSid" styleClass="wp120" onchange="changeShukeiGroupCombo();">
      <logic:notEmpty name="ntp220Form" property="ntp220GroupLavel" scope="request">
        <logic:iterate id="gpBean" name="ntp220Form" property="ntp220GroupLavel" scope="request">
          <bean:define id="gpValue" name="gpBean" property="value" type="java.lang.String" />
          <logic:equal name="gpBean" property="styleClass" value="0">
    ...
    <select name="ntp220SelectUsrSid" class="display_n">
