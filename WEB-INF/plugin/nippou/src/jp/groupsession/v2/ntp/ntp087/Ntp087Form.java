 ...
 * @author JTS
 */
public class Ntp087Form extends Ntp086Form implements ISelectorUseForm {
    ...
    /** 担当者 UI */
    private UserGroupSelector ntp087memberSidUI__ =
            UserGroupSelector.builder()
                .chainLabel(new GsMessageReq("schedule.sch100.4", null))
                ...
                .chainGroupSelectionParamName("ntp087groupSid")
                .build();
     ...
     * @see jp.groupsession.v2.ntp.ntp087.Ntp087Form#ntp087memberSidUI__
     */
