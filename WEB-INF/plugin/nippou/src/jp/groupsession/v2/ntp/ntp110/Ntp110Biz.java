...
public class Ntp110Biz {
    ...
    /** 画面ID */
    public static final String SCR_ID = "ntp110";

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Ntp110Biz.class);
    /** リクエスモデル */
     ...
     */
    public Ntp110Biz(RequestModel reqMdl) {
        reqMdl__ = reqMdl;
    }
     ...
     */
    public void setInitData(Ntp110ParamModel paramMdl)
