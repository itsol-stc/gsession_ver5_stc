...
<script src="../portal/js/ptl060kn.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<title>GROUPSESSION <gsmsg:write key="ptl.1" /> <gsmsg:write key="ptl.ptl060kn.1" /></title>
</head>
...
<div class="kanriPageTitle">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="ptl.1" /></span><gsmsg:write key="ptl.ptl060kn.1" />
    </li>
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.final" />" class="baseBtn" onClick="buttonPush2('ptl060knOk');">
          <img class="btn_classicImg-display" src="../common/images/classic/icon_kakutei.png" alt="<gsmsg:write key="cmn.final" />">
          <img class="btn_originalImg-display" src="../common/images/original/icon_kakutei.png" alt="<gsmsg:write key="cmn.final" />">
          <gsmsg:write key="cmn.final" />
        </button>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush2('ptl060knBack');">
