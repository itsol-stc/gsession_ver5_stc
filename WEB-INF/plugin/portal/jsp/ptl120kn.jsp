...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="ptl.ptl120kn.1" />
    </li>
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.final" />" class="baseBtn" onClick="buttonPush('ptl120knOk');">
          <img class="btn_classicImg-display" src="../common/images/classic/icon_kakutei.png" alt="<gsmsg:write key="cmn.final" />">
          <img class="btn_originalImg-display" src="../common/images/original/icon_kakutei.png" alt="<gsmsg:write key="cmn.final" />">
          <gsmsg:write key="cmn.final" />
        </button>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ptl120knBack');">
...
<div class="wrapper w80 mrl_auto">
  ...
  <table class="table-left w100">
    <tr>
      ...
      <td class="w80">
        <bean:write name="ptl120knForm" property="ptl120name" />
      </td>
    </tr>
    <tr>
      <th class="w20">
      ...
      <td class="w80">
        <bean:write name="ptl120knForm" property="ptl120biko" />
      </td>
    </tr>
  </table>
