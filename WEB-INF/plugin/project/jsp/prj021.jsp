      ...
      <table class="table-left">
        <tr>
          ...
          <td class="txt_l">
            <div class="display_inline-block wp50">
              ...
              ：<html:text property="prj021name0" styleClass="wp200" maxlength="20" />
          </td>
        </tr>
            ...
            <table>
              <tr>
                <td  class="border_none">
                  ...
                  <html:text property="prj021rate" styleClass="wp50" maxlength="2" />%
                  <span class="ml10">
                    <gsmsg:write key="project.src.42" />
                  </span>
                  <html:text property="prj021name" styleClass="wp200" maxlength="20" />
                </td>
                <td class="border_none">
              ...
              <tr class="border_none">
                <td class="border_none">
                  <html:select property="prj021state" size="5" styleClass="wp350 hp100 p0" multiple="true">
        ...
        <tr>
          ...
          <div class="display_inline-block wp50">
              ...
              ：<html:text property="prj021name100" styleClass="wp200" maxlength="20" />
          </td>
        </tr>
      </table>
