...
<div class="pageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <gsmsg:write key="project.prj024.1" />
    </li>
    <li>
      <div>
...
<table class="table-left">
    <tr>
      ...
      <td class="w75">
        ...
        <span class="cl_fontWarn"><gsmsg:write key="project.25" arg0="<%= lblname %>" /><br>
        <gsmsg:write key="project.26" /></span><br>
        <html:select property="prj024cateSlc" size="5" styleClass="wp300 hp100">
