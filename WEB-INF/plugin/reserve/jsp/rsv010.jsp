...
<title>GROUPSESSION <gsmsg:write key="cmn.reserve" />[<gsmsg:write key="cmn.weeks" />]
</title>
...
<body onload="init();window_create();" onunload="windowClose();calWindowClose();" class="m0 hyde">
  <html:form action="/reserve/rsv010">
    ...
    <span class="js_rsv_top_frame topFrame-fixed ">
      ...
      <bean:define id="thisForm" name="rsv010Form" type="Rsv010Form"></bean:define>
      <div class="wrapper w100">
        <reserve:rsvlistHeadPane thisForm="<%=thisForm%>" rsv020BtnEv="buttonPush('nikkan');" rsv010BtnEv="" rsv100BtnEv="moveItiran('riyo_zyokyo_syokai');" useRsvFilter="true">
          <jsp:attribute name="moveDays">
            <div class="ml_auto"></div>
            <button type="button" class=" webIconBtn" value="&nbsp;" onclick="buttonPush('zensyu_ido');">
            ...
            <button type="button" class="webIconBtn" value="&nbsp;" onclick="buttonPush('yokusyu_ido');">
