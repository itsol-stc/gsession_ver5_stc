 ...
 * @author JTS
 */
public class RsvUsedDetailListenerImpl implements IUsedDetailListener {
    ...
    public Map<String, Long> getDatails(Connection con) throws SQLException {
        ...
        RsvDatausedSumModel totalDataMdl = dataUsedDao.getTotalData();
        if (totalDataMdl != null) {
            detailMap.put("main.useddisk.rsv.syrk", totalDataMdl.getRsvSyrkSumSize());
            detailMap.put("main.useddisk.rsv.sisetsu", totalDataMdl.getRsvDataSumSize());
        }
