 ...
 * @author JTS
 */
public class Rsv220knAction extends AbstractReserveAdminAction {
    ...
    private String __getLogMessage(
        ...
        String msg = "";
        //時間単位
        msg += "[" + gsMsg.getMessage("reserve.123") + "]";
        msg += form.getRsv220HourDiv() + gsMsg.getMessage("cmn.minute");

        //開始時刻
        msg += "\r\n[" + gsMsg.getMessage("cmn.time.master") + "]";
        msg += gsMsg.getMessage("cmn.am") + " : ";
        msg += form.getRsv220AmFrHour() + gsMsg.getMessage("cmn.hour");
        String minute = form.getRsv220AmFrMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");
        msg += " ~ ";
        msg += form.getRsv220AmToHour() + gsMsg.getMessage("cmn.hour");
        minute = form.getRsv220AmToMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");
        ...
        msg += form.getRsv220PmFrHour() + gsMsg.getMessage("cmn.hour");
        minute = form.getRsv220PmFrMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");
        msg += " ~ ";
        msg += form.getRsv220PmToHour() + gsMsg.getMessage("cmn.hour");
        minute = form.getRsv220PmToMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");

        msg += "\r\n" + gsMsg.getMessage("cmn.allday") + " : ";
        msg += form.getRsv220AllDayFrHour() + gsMsg.getMessage("cmn.hour");
        minute = form.getRsv220AllDayFrMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");
        msg += " ~ ";
        msg += form.getRsv220AllDayToHour() + gsMsg.getMessage("cmn.hour");
        minute = form.getRsv220AllDayToMin();
        if (minute.equals("0")) {
            minute = "00";
        }
        msg += minute + gsMsg.getMessage("cmn.minute");
