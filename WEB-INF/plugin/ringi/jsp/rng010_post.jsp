  ...
  <tbody>
    <tr>
      <%
        ...
        String[] widthList = {"w55", "", "w15"};
        String[] titleList = {gsMsg.getMessage(request, "cmn.title"), gsMsg.getMessage(request, "rng.47"), gsMsg.getMessage(request, "rng.application.date")};
        int[] sortKeyList = {0,  1,  2};
