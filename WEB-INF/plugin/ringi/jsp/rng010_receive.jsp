  ...
  <tbody>
    <tr>
      <%
        ...
        String[] titleList = {gsMsg.getMessage(request, "cmn.title"), gsMsg.getMessage(request, "rng.47"), gsMsg.getMessage(request, "rng.application.date"), gsMsg.getMessage(request, "cmn.received.date")};
