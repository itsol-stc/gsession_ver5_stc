...
<meta name="format-detection" content="telephone=no">
    ...
    <title>GROUPSESSION <gsmsg:write key="rng.62" /> <gsmsg:write key="rng.49" /></title>
  </head>
  <body>
    <html:form styleId="rngForm" action="ringi/rng050">
      ...
      <html:hidden property="rng050rngNowDate" />
      <html:hidden property="rng050outPutDirHash" />
      <html:hidden property="rngProcMode" />
      <input type="hidden" name="yearRangeMinFr" value="<bean:write name="rng050Form" property="rng050MinYear" />" />
      <input type="hidden" name="yearRangeMaxFr" value="0" />
      <input type="hidden" name="yearRangeMinTo" value="<bean:write name="rng050Form" property="rng050MinYear" />" />
      ...
      <script>
       msglist_rng050 = new Array();
       msglist_rng050['cmn.number'] = '<gsmsg:write key="cmn.number"/>';
       msglist_rng050['cmn.pdf'] = '<gsmsg:write key="cmn.pdf"/>';
      </script>
      <!-- BODY -->
      <div class="kanriPageTitle mrl_auto">
        <ul>
          ...
          <li class="pageTitle_subFont">
            <span class="pageTitle_subFont-plugin"><gsmsg:write key="rng.62" /></span><gsmsg:write key="rng.49" />
          </li>
          <li>
            <div>
      ...
      <div class="wrapper mrl_auto">
        ...
        <table class="table-left w100">
          <tr>
            <td colspan="4" class="w100 table_title-color">
              ...
              <span class="table_title-color"><gsmsg:write key="rng.49" /></span>
            </td>
          </tr>
          <tr>
            <th class="w25">
            ...
            <td class="w75">
              <html:text name="rng050Form" property="rngInputKeyword" styleClass="wp400" maxlength="100" />
            </td>
          </tr>
          <tr>
            <th class="w25">
            ...
            <td class="w75">
              ...
              <button class="iconBtn-border " type="button" id="rng050GroupBtn" value="&nbsp;&nbsp;" onClick="setDateParam();openGroupWindow(this.form.sltGroupSid, 'sltGroupSid', '0');">
          ...
          <tr>
            ...
            <td class="w75">
              <div class="verAlignMid mr5">
                <html:text name="rng050Form" property="rng050ApplDateFr" maxlength="10" styleClass="txt_c wp95 datepicker js_frDatePicker" styleId="selDateaf" />
              ...
              <div class="verAlignMid">
                <html:text name="rng050Form" property="rng050ApplDateTo" maxlength="10" styleClass="txt_c wp95 datepicker js_toDatePicker" styleId="selDateat" />
          ...
          <tr>
            ...
            <td class="w75">
              <div class="verAlignMid mr5">
                <html:text name="rng050Form" property="rng050LastManageDateFr" maxlength="10" styleClass="txt_c wp95 datepicker js_frDatePicker" styleId="selDatelf" />
                <span class="picker-acs icon-date display_flex cursor_pointer iconKikanStart"></span>
              </div>
              <span class="mr5"><gsmsg:write key="tcd.153" /></span>
              <div class="verAlignMid">
                <html:text name="rng050Form" property="rng050LastManageDateTo" maxlength="10" styleClass="txt_c wp95 datepicker js_toDatePicker" styleId="selDatelt" />
                <span class="picker-acs icon-date display_flex cursor_pointer iconKikanFinish"></span>
              </div>
            </td>
          </tr>
        ...
        <div class="txt_r mb5">
          <logic:notEmpty name="rng050Form" property="rng050rngDataList">
            ...
            <button type="button" class="baseBtn" name="btn_usrimp" value="<gsmsg:write key="cmn.export" />" onClick="rngCsvExportButton('rng050', 'export');">
        ...
        <%
           ...
           String[] title_width = new String[] { "w20", "w15", "w15", "w50"};
        ...
        %>
        <table class="table-top" id="selectionSearchArea">
          <tr>
            <%
            ...
            %>
            <th class="<%= title_width[i] %> table_title-color cursor_p" onClick="return sorton(<%= skey %>, <%= order %>);">
          ...
          <logic:notEmpty name="rng050Form" property="rng050rngDataList">
            <logic:iterate id="rngData" name="rng050Form" property="rng050rngDataList" indexId="idx" scope="request">
              <tr class="js_listHover cursor_p" id="<bean:write name="rngData" property="rngSid" />">
                ...
                <td class="keiro_status js_listClick">
                  ...
                  <logic:notEmpty name="rngData" property="keiroNameList">
                    <% int beforeStatus = jp.groupsession.v2.rng.RngConst.RNG_RNCSTATUS_APPR; %>
                    <logic:iterate id="channelData" name="rngData" property="keiroNameList" indexId="channelIdx">
          ...
          <tr>
            <td id="pdfOutput" class="loading_area w100 txt_m">
              ...
              <p id="outputCount" class="txt_c">
                 <logic:greaterThan value="0" name="rng050Form" property="rng050pdfOutputMax">
                    <bean:write name="rng050Form" property="rng050pdfOutputCnt"/><gsmsg:write key="cmn.number"/>&nbsp;
                    /&nbsp;<bean:write name="rng050Form" property="rng050pdfOutputMax"/><gsmsg:write key="cmn.number"/>
                 </logic:greaterThan>
              </p>
              <p class="txt_c">
