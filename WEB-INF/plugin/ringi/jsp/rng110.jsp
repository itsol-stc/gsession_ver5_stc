...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <logic:equal name="rng110Form" property="rngRctCmdMode" value="<%= String.valueOf(jp.groupsession.v2.rng.RngConst.RNG_CMDMODE_ADD) %>">
...
<div class="wrapper w80 mrl_auto">
  ...
  <table class="table-left w100">
    <tr>
      <th class="w20"><gsmsg:write key="rng.rng110.02" />
        <span class="cl_fontWarn">
          <gsmsg:write key="cmn.comments" />
        </span>
      </th>
      <td class="td_wt w80">
        <html:text name="rng110Form" property="rng110name" styleClass="wp300" maxlength="20" />
        <input type="text" name="dammy" class="display_n" maxlength="20" />
      </td>
    </tr>
    <!-- 経路 -->
    <tr>
      <th class="w20"><gsmsg:write key="rng.24" />
        <span class="cl_fontWarn">
          <gsmsg:write key="cmn.comments" />
        </span>
      </th>
      <td class="td_wt w80">
        <ringi:rng110_keiro name="rng110Form" property="rng110keiro" keiroShareRange="<%=RngConst.RNG_TEMPLATE_PRIVATE %>" />
      </td>
    </tr>
  </table>
