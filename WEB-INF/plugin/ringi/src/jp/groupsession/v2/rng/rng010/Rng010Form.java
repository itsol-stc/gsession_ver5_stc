...
public class Rng010Form extends AbstractRingiForm {
     ...
     * @param addFlg 追加フラグ true:rngTemplateMode,rng010DelSidListを追加する，false:追加しない
     */
    public void setHiddenParam(Cmn999Form msgForm, boolean addFlg) {
        if (addFlg) {
            msgForm.addHiddenParam("rng010DelSidList", rng010DelSidList__);
            msgForm.addHiddenParam("rngTemplateMode", getRngTemplateMode());
        }
        
        msgForm.addHiddenParam("rng010ViewAccount", rng010ViewAccount__);
        ...
        msgForm.addHiddenParam("rng010SelectCategory", rng010SelectCategory__);
        msgForm.addHiddenParam("rng010SelectCategoryUser", rng010SelectCategoryUser__);
        msgForm.addHiddenParam("rng010SearchCategory", rng010SearchCategory__);
    }
    /**
     * <br>[機  能] 共通メッセージ画面遷移時に保持する戻り先を設定する
     * <br>[解  説]
     * <br>[備  考]
     * @param msgForm 共通メッセージ画面Form
     */
    public void setConfHiddenParam(Cmn999Form msgForm) {
     ...
     * @see jp.groupsession.v2.rng.rng010.Rng010Form#rng010TemplatePersonalFlg__
     */
