...
public class Rng050Form extends Rng010Form {
    ...
    public ActionErrors validateCheck(HttpServletRequest req)
        ...
        if (!StringUtil.isNullZeroString(rng050ApplDateFr__)) {
            errors.add(picker.setYmdParam(this, "rng050ApplDateFr",
        ...
        if (!StringUtil.isNullZeroString(rng050ApplDateTo__)) {
            errors.add(picker.setYmdParam(this, "rng050ApplDateTo",
        ...
        inputFrom = false;
        inputTo = false;
        if (!StringUtil.isNullZeroString(rng050LastManageDateFr__)) {
            errors.add(picker.setYmdParam(this, "rng050LastManageDateFr",
        ...
        if (!StringUtil.isNullZeroString(rng050LastManageDateTo__)) {
            errors.add(picker.setYmdParam(this, "rng050LastManageDateTo",
     ...
     * @see jp.groupsession.v2.rng.rng050.Rng050Form#rng050pdfOutputCnt__
     */
     ...
     * @see jp.groupsession.v2.rng.rng050.Rng050Form#rng050pdfOutputMax__
     */
