...
public class Rng070Form extends Rng010Form {
    ...
    public ActionErrors validateCheck(HttpServletRequest req)
        ...
        if (!StringUtil.isNullZeroString(rng070ApplDateFr__)) {
            errors.add(picker.setYmdParam(this, "rng070ApplDateFr",
        ...
        if (!StringUtil.isNullZeroString(rng070ApplDateTo__)) {
            errors.add(picker.setYmdParam(this, "rng070ApplDateTo",
        ...
        inputFrom = false;
        inputTo = false;
        if (!StringUtil.isNullZeroString(rng070LastManageDateFr__)) {
            errors.add(picker.setYmdParam(this, "rng070LastManageDateFr",
        ...
        if (!StringUtil.isNullZeroString(rng070LastManageDateTo__)) {
            errors.add(picker.setYmdParam(this, "rng070LastManageDateTo",
     ...
     * @see jp.groupsession.v2.rng.rng070.Rng070Form#rng070pdfOutputCnt__
     */
     ...
     * @see jp.groupsession.v2.rng.rng070.Rng070Form#rng070pdfOutputMax__
     */
     ...
     * @return rng070Kekka
     * @see jp.groupsession.v2.rng.rng070.Rng070Form#rng070Kekka__
     */
