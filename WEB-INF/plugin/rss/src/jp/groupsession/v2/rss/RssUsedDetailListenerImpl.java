 ...
 * @author JTS
 */
public class RssUsedDetailListenerImpl implements IUsedDetailListener {
    ...
    public Map<String, Long> getDatails(Connection con) throws SQLException {
        ...
        RssDatausedSumModel totalDataMdl = dataUsedDao.getTotalData();
        if (totalDataMdl != null) {
            detailMap.put("main.useddisk.rss.rssdata", totalDataMdl.getRssDataSize());
        }
