...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
     <span class="pageTitle_subFont-plugin"><gsmsg:write key="schedule.108" /></span><gsmsg:write key="cmn.import" />
    </li>
    <li>
      <div>
    ...
    <tr>
      ...
      <td>
        <span class="verAlignMid">
          <html:checkbox name="sch084Form" property="sch084repeatCheckFlg" value="1" styleId="checkFlg" />
          <label for="checkFlg"><gsmsg:write key="schedule.sch084.1" /></label>
        </span>
      </td>
    </tr>
  </table>
