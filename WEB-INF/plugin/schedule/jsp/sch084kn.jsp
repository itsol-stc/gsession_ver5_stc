...
<script src="../schedule/js/sch084.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="schedule.108" /></span><gsmsg:write key="main.man029kn.2" />
    </li>
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.ok" />" class="baseBtn" onClick="buttonPush('doImport');">
...
<div class="cl_fontWarn fw_b txt_l"><gsmsg:write key="cmn.capture.file.sure" /></div>
  <table class="table-left">
    <tr>
      ...
      <bean:write name="sch084knForm" property="sch084knFileName" />
      </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
      <bean:write name="sch084knForm" property="impDataCnt" /><gsmsg:write key="cmn.number" />
      </td>
    </tr>
    <tr>
      <th>
      <gsmsg:write key="schedule.sch084.2" />
      </th>
      <td>
