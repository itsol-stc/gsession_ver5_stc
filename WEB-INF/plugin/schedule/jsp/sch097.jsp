...
<script src="../schedule/js/sch097.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" value="<gsmsg:write key="cmn.ok" />" class="baseBtn" onClick="buttonPush('sch097kakunin');">
        <img class="btn_classicImg-display" src="../common/images/classic/icon_ok.png" alt="<gsmsg:write key="cmn.ok" />">
        <img class="btn_originalImg-display" src="../common/images/original/icon_check.png" alt="<gsmsg:write key="cmn.ok" />">
        <gsmsg:write key="cmn.ok" />
        </button>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch097back');">
    ...
    <tr>
      ...
      <td class="w75">
        <span class="verAlignMid">
          <html:radio onclick="showOrHide();" name="sch097Form" styleId="sch097Repeat_00" property="sch097RepeatKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_REPEAT_KBN_OK) %>" />
          <label for="sch097Repeat_00"><gsmsg:write key="cmn.accepted" /></label>
          <html:radio onclick="showOrHide();" name="sch097Form" styleId="sch097Repeat_01" styleClass="ml10" property="sch097RepeatKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_REPEAT_KBN_NG) %>" />
          <label for="sch097Repeat_01"><gsmsg:write key="cmn.not" /></label>
          <html:radio onclick="showOrHide();" name="sch097Form" styleId="sch097Repeat_02" styleClass="ml10" property="sch097RepeatKbn" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_REPEAT_KBN_WARNING) %>" />
          <label for="sch097Repeat_02"><gsmsg:write key="schedule.sch097.1" /></label>
        </span>
        <div class="settingForm_separator" id="show">
          <span class="verAlignMid" >
            <html:checkbox name="sch097Form" styleId="huka" property="sch097RepeatMyKbn" value="1" /><label for="huka"><gsmsg:write key="schedule.sch097.2" /></label>
          </span>
        </div>
        <span id="hide">&nbsp;</span>
      </td>
