...
/**
 * <p>SCH_EXDATA Data Bindding JavaBean
 *
 * @author JTS DaoGenerator version 0.1
 */
public class SchExdataModel extends AbstractModel {
    ...
    /** SCE_DAILY mapping */
    private int sceDaily__;
    /** SCE_DAYS_MONTH mapping */
    private int sceDaysMonth__;
    /** SCE_PERIOD_KBN mapping */
    private int scePeriodKbn__;
    /** SCE_TARGET_GRP mapping */
    private int sceTargetGrp__;
    /** SCE_REMINDER mapping */
    private int sceReminder__;

    /**
     * <p>sceDaily を取得します。
     * @return sceDaily
     */
    public int getSceDaily() {
        return sceDaily__;
    }

    /**
     * <p>sceDaily をセットします。
     * @param sceDaily sceDaily
     */
    public void setSceDaily(int sceDaily) {
        sceDaily__ = sceDaily;
    }
    ...
    /**
     * <p>get SCE_DAYS_MONTH value
     * @return SCE_DAYS_MONTH value
     */
    public int getSceDaysMonth() {
        return sceDaysMonth__;
    }

    /**
     * <p>set SCE_DAYS_MONTH value
     * @param sceDaysMonth SCE_DAYS_MONTH value
     */
    public void setSceDaysMonth(int sceDaysMonth) {
        sceDaysMonth__ = sceDaysMonth;
    }

    /**
     * <p>scePeriodKbn を取得します。
     * @return scePeriodKbn
     * @see jp.groupsession.v2.sch.model.SchExdataModel#scePeriodKbn__
     */
    public int getScePeriodKbn() {
        return scePeriodKbn__;
    }

    /**
     * <p>scePeriodKbn をセットします。
     * @param scePeriodKbn scePeriodKbn
     * @see jp.groupsession.v2.sch.model.SchExdataModel#scePeriodKbn__
     */
    public void setScePeriodKbn(int scePeriodKbn) {
        scePeriodKbn__ = scePeriodKbn;
    }

    /**
     * <p>get SCE_TARGET_GRP value
     * @return SCE_TARGET_GRP value
     */
    public int getSceTargetGrp() {
        return sceTargetGrp__;
    }

    /**
     * <p>set SCE_TARGET_GRP value
     * @param sceTargetGrp SCE_TARGET_GRP value
     */
    public void setSceTargetGrp(int sceTargetGrp) {
        sceTargetGrp__ = sceTargetGrp;
    }

    /**
     * <p>get SCE_REMINDER value
     * @return SCE_REMINDER value
     */
    public int getSceReminder() {
        return sceReminder__;
    }

    /**
     * <p>set SCE_REMINDER value
     * @param sceReminder SCE_REMINDER value
     */
    public void setSceReminder(int sceReminder) {
        sceReminder__ = sceReminder;
    }
    ...
    public String toCsvString() {
        ...
        buf.append(sceKbn__);
        buf.append(",");
        buf.append(sceDweek1__);
        buf.append(",");
        buf.append(sceDweek2__);
        buf.append(",");
        buf.append(sceDweek3__);
        buf.append(",");
        buf.append(sceDweek4__);
        buf.append(",");
        buf.append(sceDweek5__);
        buf.append(",");
        buf.append(sceDweek6__);
        buf.append(",");
        buf.append(sceDweek7__);
        buf.append(",");
        buf.append(sceDay__);
        buf.append(",");
        buf.append(sceWeek__);
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceTimeFr__, ""));
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceTimeTo__, ""));
        buf.append(",");
        buf.append(sceTranKbn__);
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceDateFr__, ""));
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceDateTo__, ""));
        buf.append(",");
        buf.append(sceBgcolor__);
        buf.append(",");
        buf.append(NullDefault.getString(sceTitle__, ""));
        buf.append(",");
        buf.append(NullDefault.getString(sceValue__, ""));
        buf.append(",");
        buf.append(NullDefault.getString(sceBiko__, ""));
        buf.append(",");
        buf.append(scePublic__);
        buf.append(",");
        buf.append(sceEdit__);
        buf.append(",");
        buf.append(sceAuid__);
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceAdate__, ""));
        buf.append(",");
        buf.append(sceEuid__);
        buf.append(",");
        buf.append(NullDefault.getStringFmObj(sceEdate__, ""));
        buf.append(",");
        buf.append(sceDaysMonth__);
        buf.append(",");
        buf.append(scePeriodKbn__);
        buf.append(",");
        buf.append(sceTargetGrp__);
        buf.append(",");
        buf.append(sceReminder__);
        return buf.toString();
    }
