...
public class Sch030Action extends AbstractScheduleAction {
    ...
    /** テンポラリディレクトリID*/
    private static final String TEMP_DIRECTORY_ID = "sch030";
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        if (cmd.equals("week")) {
            ...
            __doInit(map, uform, req, res, con);
        } else if (cmd.equals("sch030IkkatuTouroku")) {
            //一括登録
            forward = __doIkkatsuEntry(map, uform, req, res, con);
        } else if (cmd.equals("sch030IkkatuRemove")) {
            //一括登録削除
            __doIkkatsuRemove(map, uform, req, res, con);
            forward = map.getInputForward();
        } else if (cmd.equals("sch030IkkatuList")) {
            //一括選択リスト取得
    ...
    private void __doInit(ActionMapping map, Sch030Form form,
        ...
        Sch030Biz biz = new Sch030Biz(
                getPluginConfigForMain(getPluginConfig(req),
                        con, getSessionUserSid(req)), reqMdl);
    ...
    private ActionForward __createPdf(ActionMapping map, Sch030Form form,
        ...
        String dspName = gsMsg.getMessage("schedule.sch030.1");
    ...
    private void __doIkkatsuList(
        ...
        Sch030ParamModel paramMdl = new Sch030ParamModel();
        paramMdl.setParam(form);
        Sch030Biz biz = new Sch030Biz(getPluginConfig(req), reqMdl);
    ...
    private ActionForward __doIkkatsuEntry(
        ...
        return map.findForward("030_add");
    }
     ...
     * @return ActionForward
     */
    private ActionForward __doCompDsp(ActionMapping map, Sch030Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con) {
        ActionForward forward = null;
