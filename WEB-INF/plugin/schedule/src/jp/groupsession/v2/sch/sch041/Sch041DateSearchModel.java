...
public class Sch041DateSearchModel extends AbstractModel {
    ...
    /** 日付指定区分 から */
    private String dayOfMonthStart__;
    /** 日付指定区分 まで */
    private String dayOfMonthEnd__;
    ...
    /**
     * <p>dayOfMonthStart を取得します。
     * @return dayOfMonthStart
     * @see jp.groupsession.v2.sch.sch041.Sch041DateSearchModel#dayOfMonthStart__
     */
    public String getDayOfMonthStart() {
        return dayOfMonthStart__;
    }
    /**
     * <p>dayOfMonthStart をセットします。
     * @param dayOfMonthStart dayOfMonthStart
     * @see jp.groupsession.v2.sch.sch041.Sch041DateSearchModel#dayOfMonthStart__
     */
    public void setDayOfMonthStart(String dayOfMonthStart) {
        dayOfMonthStart__ = dayOfMonthStart;
    }
    /**
     * <p>dayOfMonthEnd を取得します。
     * @return dayOfMonthEnd
     * @see jp.groupsession.v2.sch.sch041.Sch041DateSearchModel#dayOfMonthEnd__
     */
    public String getDayOfMonthEnd() {
        return dayOfMonthEnd__;
    }
    /**
     * <p>dayOfMonthEnd をセットします。
     * @param dayOfMonthEnd dayOfMonthEnd
     * @see jp.groupsession.v2.sch.sch041.Sch041DateSearchModel#dayOfMonthEnd__
     */
    public void setDayOfMonthEnd(String dayOfMonthEnd) {
        dayOfMonthEnd__ = dayOfMonthEnd;
    }
