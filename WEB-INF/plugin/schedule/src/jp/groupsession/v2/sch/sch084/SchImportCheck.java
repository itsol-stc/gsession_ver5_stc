            ...
            try {
                ...
                if (stringTokenizer.length() != GSConstSchedule.IMP_VALUE_SIZE_ADM) {
                    ...
                    while (stringTokenizer.hasMoreTokens()) {
                        ...
                        //公開区分
                        if (j == 12) {
                            __isOkPub(errors__, buff, inputFlg, num);
                        }
...
//                } catch (NumberFormatException e) {
     ...
     * @param errors ActionErrors
     * @param pub 公開区分
     * @param usrInputFlg ログインID入力フラグ true:入力、false:未入力
     * @param num 行数
     * @return ActionErrors
     */
    private ActionErrors __isOkPub(ActionErrors errors, String pub, boolean usrInputFlg, long num) {
