...
<title>GROUPSESSION <gsmsg:write key="tcd.50" /> <gsmsg:write key="cmn.preferences2" />[<gsmsg:write key="tcd.48" />]</title>
</head>
<body>
...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li>
      <div>
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('tcd100back')">
...
<div class="wrapper w80 mrl_auto">
  <div class="settingList">
    <dl>
      <dt onClick="return buttonPush('basicSetting');">
        <span class="settingList_title"><gsmsg:write key="cmn.preferences" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="tcd.tcd100.01" /></div>
      </dd>
    </dl>
  </div>
</div>
