 ...
 * @author JTS
 */
public class TcdUsedDetailListenerImpl implements IUsedDetailListener {
    ...
    public Map<String, Long> getDatails(Connection con) throws SQLException {
        ...
        TcdDatausedSumModel totalDataMdl = dataUsedDao.getTotalData();
        if (totalDataMdl != null) {
            detailMap.put("main.useddisk.tcd.tcddata", totalDataMdl.getTcdTcdataSize());
        }
