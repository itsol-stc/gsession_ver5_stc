...
public class Tcd040Form extends Tcd030Form {
     ...
     * @see jp.groupsession.v2.tcd.tcd040.Tcd040Form#tcd040holMaltiList__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd040.Tcd040Form#tcd040HolidayCk__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd040.Tcd040Form#tcd040HolidayCkSv__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd040.Tcd040Form#tcd040SortKeyHoliday__
     */
    ...
    public ActionErrors validateCheck(RequestModel reqMdl) {
        ...
        if (getTcd040HolidayCk() != null) {
            String holiday = gsMsg.getMessage("tcd.tcd040.25");
            for (String holKbn : getTcd040HolidayCk()) {
                if (!ValidateUtil.isNumber(holKbn)) {
                    msg = new ActionMessage("error.input.notvalidate.data", holiday);
