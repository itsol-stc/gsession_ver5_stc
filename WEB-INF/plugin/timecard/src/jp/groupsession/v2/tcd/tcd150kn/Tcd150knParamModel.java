...
import jp.groupsession.v2.tcd.tcd150.Tcd150ParamModel;

/**
 * <br>[機  能] タイムカード CSVインポート確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Tcd150knParamModel extends Tcd150ParamModel {
     ...
     * <p>userUkoFLg を取得します。
     * @return userUkoFLg
     * @see jp.groupsession.v2.tcd.tcd150kn.Tcd150knParamModel#userUkoFLg__
     */
