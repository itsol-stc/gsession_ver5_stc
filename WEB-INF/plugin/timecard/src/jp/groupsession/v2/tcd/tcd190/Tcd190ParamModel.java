...
/**
 * <br>[機  能] タイムカード管理者設定 有休日数一覧画面のパラメータ情報クラスです。
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Tcd190ParamModel extends Tcd030ParamModel {

    /** 表示年度 */
    private int tcd190nendo__;
    /** 表示グループ */
    private String tcd190group__;
     ...
     * @return tcdNendoList
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcdNendoList__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcd190pageList__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcd190YukyuModelList__
     */
     ...
     * @return tcd200Group
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcd200Group__
     */
     ...
     * @return tcdGroupList
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcdGroupList__
     */
     ...
     * @return tcdUserList
     * @see jp.groupsession.v2.tcd.tcd190.Tcd190ParamModel#tcdUserList__
     */
