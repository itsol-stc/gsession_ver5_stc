...
import jp.groupsession.v2.tcd.tcd200.Tcd200ParamModel;
/**
 * <br>[機  能] タイムカード 有休日数登録,編集確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Tcd200knParamModel extends Tcd200ParamModel {
     ...
     * @see jp.groupsession.v2.tcd.tcd200kn.Tcd200knParamModel#tcd200editUser__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd200kn.Tcd200knParamModel#tcd200editNendo__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd200kn.Tcd200knParamModel#tcd200editUserName__
     */
     ...
     * @see jp.groupsession.v2.tcd.tcd200kn.Tcd200knParamModel#tcd200editUserUkoFlg__
     */
