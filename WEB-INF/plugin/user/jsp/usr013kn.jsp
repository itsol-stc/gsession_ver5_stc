...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="cmn.shain.info" /></span><gsmsg:write key="user.usr013kn.1" />
    </li>
    <li>
      <div>
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('Usr013kn_Back');">
...
<logic:messagesPresent message="false">
  ...
  <table class="table-left">
    <tr>
      ...
      <td class="w75">
        <bean:write name="usr013knForm" property="usr013knFileName" />
      </td>
    </tr>
    <tr>
      <th>
        <gsmsg:write key="user.usr013kn.3" />
      </th>
      <td>
        <logic:notEmpty name="usr013knForm" property="usr013knImpList" scope="request">
          <logic:iterate id="groupModel" name="usr013knForm" property="usr013knImpList" scope="request">
            <bean:write name="groupModel" property="grpId" />&nbsp;&nbsp;<bean:write name="groupModel" property="grpName" /><br>
          </logic:iterate>
        </logic:notEmpty>
      </td>
    </tr>
