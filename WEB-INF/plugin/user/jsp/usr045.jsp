...
<table class="table-left">
    <tr>
      ...
      <td class="w75">
        <html:text styleClass="wp230" maxlength="20" property="usr045CategoryName" />
      </td>
    </tr>
    <tr>
      <th>
      ...
      <td>
        <textarea name="usr045bikou" rows="5" class="wp550" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="usr045Form" property="usr045bikou" /></textarea>
        <div class="fs_13">
          <gsmsg:write key="cmn.current.characters" /><gsmsg:write key="cmn.colon" /><span id="inputlength">0</span>&nbsp;/&nbsp;<%= maxLengthBiko %>&nbsp;<gsmsg:write key="cmn.character" />
        </div>
      </td>
    </tr>
  </table>
