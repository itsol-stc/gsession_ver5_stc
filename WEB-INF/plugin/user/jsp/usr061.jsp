    ...
    <div class="kanriPageTitle w80 mrl_auto">
      <ul>
        ...
        <li class="pageTitle_subFont">
          <span class="pageTitle_subFont-plugin"><gsmsg:write key="cmn.shain.info" /></span><gsmsg:write key="user.usr060.1" />
        </li>
        <li>
          <div>
            <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.ok" />" onClick="return buttonPush('usr061Ok');">
              <img class="btn_classicImg-display" src="../common/images/classic/icon_ok.png" alt="<gsmsg:write key="cmn.ok" />">
              <img class="btn_originalImg-display" src="../common/images/original/icon_check.png" alt="<gsmsg:write key="cmn.ok" />">
              <gsmsg:write key="cmn.ok" />
            </button>
            <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="return buttonPush('usr061Back');">
      ...
      <table cellpadding="5" cellspacing="0" border="0" class="table-left">
        ...
        <tr>
          ...
          <td class="txt_m txt_l" colspan="5">
            <html:text name="usr061Form" property="usr060SendToAddress" styleClass="wp350" maxlength="256" />
          </td>
        </tr>
      </table>
