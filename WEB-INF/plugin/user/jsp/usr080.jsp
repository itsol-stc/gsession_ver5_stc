  ...
  <ul>
    ...
    <li>
      <div>
        ...
        <button type="button" class="baseBtn" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('usr080back');">
...
<div class="wrapper w80 mrl_auto">
  <div class="settingList">
    <dl>
      <dt onClick="return buttonPush('defoSort');">
        <span class="settingList_title"><gsmsg:write key="cmn.display.settings" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="user.usr080.4" /></div>
      </dd>
    </dl>
    <dl>
      <dt onClick="return buttonPush('labelConf');">
        <span class="settingList_title"><gsmsg:write key="cmn.setting.permissions" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="user.usr080.5" /></div>
      </dd>
    </dl>
    <dl>
      <dt onClick="return buttonPush('basic');">
        <span class="settingList_title"><gsmsg:write key="cmn.export.restrictions.set" /></span>
      </dt>
      <dd>
        <div class="settingList_text"><gsmsg:write key="user.usr080.2" /></div>
      </dd>
    </dl>
  </div>
</div>
