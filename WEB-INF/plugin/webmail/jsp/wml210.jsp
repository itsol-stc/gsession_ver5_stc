...
<div class="kanriPageTitle w80 mrl_auto">
  <ul>
    ...
    <li class="pageTitle_subFont">
      <span class="pageTitle_subFont-plugin"><gsmsg:write key="wml.wml010.25" /></span><gsmsg:write key="cmn.entry.label" />
    </li>
    <li>
      <div>
        ...
        <button type="button" value="<gsmsg:write key="cmn.back" />" class="baseBtn" onClick="buttonPush('labelList');">
...
<div class="wrapper w80 mrl_auto">
  ...
  <table class="table-left mt0">
    ...
    <tr>
      ...
      <td class="w75">
        <html:text name="wml210Form" property="wml210LabelName" maxlength="100" styleClass="wp550" />
      </td>
    </tr>
  </table>
