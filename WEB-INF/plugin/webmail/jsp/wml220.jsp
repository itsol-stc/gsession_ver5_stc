...
<head>
  ...
  <script src="../webmail/js/wml220.js?<%= GSConst.VERSION_PARAM %>"></script>
  ...
  <ul>
    ...
    <li>
      <div>
        ...
        <button type="button" value="<gsmsg:write key="cmn.back" />" class="baseBtn" onClick="buttonPush('wml220Back');">
...
<logic:messagesPresent message="false">
  ...
  <table class="table-left mt0">
    ...
    <td class="w100 txt_l">
      <bean:write name="wml220Form" property="wml220accountName" />
    </td>
    </tr>
  </table>
  ...
  <logic:iterate id="filData" name="wml220Form" property="filList" indexId="idx">
    ...
    <tr>
      <td class="txt_c js_tableTopCheck cursor_p no_w">
        <html:radio property="wml220SortRadio" value="<%= String.valueOf(filValue) %>" styleId="<%= filterCheckId %>" />
      </td>
      <td>
