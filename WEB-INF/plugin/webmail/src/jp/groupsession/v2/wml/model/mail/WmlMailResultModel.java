...
/**
 * <br>[機  能] WEBメール メール取得情報を格納するクラス
 * <br>[解  説]
 * <br>[備  考] メールの送信時には使用しない
 *
 * @author JTS
 */
public class WmlMailResultModel {
    ...
    /** ラベル情報一覧 */
    private List<WmlMailLabelModel> labelList__ = null;
    /** 送信先 */
    private WmlMailSendAddrModel sendAddress__ = null;
    /** 添付ファイル */
     ...
     * <p>dirType を取得します。
     * @return dirType
     * @see jp.groupsession.v2.wml.wml010.model.Wml010MailModel#dirType__
     */
     ...
     * @return labelList
     */
    public List<WmlMailLabelModel> getLabelList() {
        return labelList__;
    }
    /**
     * <p>labelList をセットします。
     ...
     */
    public void setLabelList(List<WmlMailLabelModel> labelList) {
     ...
     * @return sendAddress
     */
    public WmlMailSendAddrModel getSendAddress() {
     ...
     */
    public void setSendAddress(WmlMailSendAddrModel sendAddress) {
