...
/**
 * <br>[機  能] WEBメール 編集メール送信用ビジネスロジック
 * <br>[解  説]
 * <br>[備  考]
 */
public class WmlAccountsMailsSendPutBiz {
    ...
    /** パラメータ */
    private WmlAccountsMailsSendPutParamModel param__;
    /** GSコンテキスト */
     ...
     */
    public WmlAccountsMailsSendPutBiz(WmlAccountsMailsSendPutParamModel param,
    ...
    */
    ...
    private void __outputResultLog(SmtpSendModel sendData)  {
        ...
        wmlBiz.outPutApiLog(reqMdl, ctx__.getCon(), ctx__.getRequestUserSid(),
                "RESTAPI_MAIL_EDIT_SEND", gsMsg.getMessage("cmn.sent"),
