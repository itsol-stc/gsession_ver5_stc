...
public class Wml030SearchModel extends AbstractModel {
    ...
    /** 認証区分*/
    private int ninsyoKbn__ = -1;
    /** 認証状態区分*/
    private int ninsyoStatusKbn__ = 0;
    ...
    public int getNinsyoKbn() {
        return ninsyoKbn__;
    }
    public void setNinsyoKbn(int ninsyoKbn) {
        ninsyoKbn__ = ninsyoKbn;
    }
    public int getNinsyoStatusKbn() {
        return ninsyoStatusKbn__;
    }
    public void setNinsyoStatusKbn(int ninsyoStatusKbn) {
        ninsyoStatusKbn__ = ninsyoStatusKbn;
    }
}
