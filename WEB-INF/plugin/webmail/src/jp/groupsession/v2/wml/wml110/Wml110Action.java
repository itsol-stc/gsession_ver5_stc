...
//        }
    ...
    private ActionForward __doDeleteComp(
        ...
        WmlLabelModel delLabelMdl = wlDao.select(form.getWmlEditLabelId());
        String delLabelName = delLabelMdl.getWlbName();
        ...
        WmlAccountModel accountMdl = accountDao.select(paramMdl.getWml110accountSid());
        String msg = "[" + gsMsg.getMessage("wml.96") + "] " + accountMdl.getWacName();
        msg += "\r\n[" + gsMsg.getMessage("wml.74") + "] " + delLabelName;
...
//        String msg = biz.getDeletePosMsg(con, form.getAdr080EditAtiSid(), msgRes);
    ...
    private ActionForward __doSortChange(
        ...
        try {
            ...
            Wml110ParamModel paramMdl = new Wml110ParamModel();
            paramMdl.setParam(form);
            updateFlg = biz.updateSort(con, paramMdl, changeKbn);
            paramMdl.setFormData(form);
            commitFlg = true;
        ...
        if (updateFlg) {
            ...
            String msg = "";
            String sort = "";
            String accountName = biz.getAccountName(con, form.getWml110accountSid());
            String[] selectKeyList = form.getWml110SortRadio().split(":");
            String targetName = biz.getLabelName(con, Integer.parseInt(selectKeyList[0]));
            if (changeKbn == 0) {
