...
//        }
    ...
    private ActionForward __doDeleteComp(
        ...
        WmlAccountModel accountMdl = accountDao.select(paramMdl.getWml130accountSid());
...
//        String msg = biz.getDeletePosMsg(con, form.getAdr080EditAtiSid(), msgRes);
    ...
    private ActionForward __doSortChange(
        ...
        if (updateFlg) {
            ...
            String msg = "";
            String sort = "";
            String accountName = biz.getAccountName(con, form.getWml130accountSid());
            String[] selectKeyList = form.getWml130SortRadio().split(":");
            String targetName = biz.getFilterName(con, Integer.parseInt(selectKeyList[0]));
            if (changeKbn == 0) {
