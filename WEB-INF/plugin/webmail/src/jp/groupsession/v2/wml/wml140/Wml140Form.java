...
public class Wml140Form extends Wml130Form {
    ...
    /** フォルダ移動先 移動する */
    public static final int WML140_MOVEFOLDER_DO = GSConstWebmail.FILTER_MOVE_DUST;
    ...
    /** 動作 フォルダに移動する */
    private String wml140actionMove__ = "0";
    /** 選択 フォルダ */
    private String wml140actionFolderValue__ = String.valueOf(GSConstWebmail.FILTER_MOVE_DUST);
    /** アドレス 転送先 判定*/
     ...
     * @return エラー
     */
    public ActionErrors validateCheck(HttpServletRequest req, Connection con) throws Exception {
        ...
        //条件未選択
        if (StringUtil.isNullZeroString(wml140condition1__)
         && StringUtil.isNullZeroString(wml140condition2__)
         && StringUtil.isNullZeroString(wml140condition3__)
         && StringUtil.isNullZeroString(wml140condition4__)
         && StringUtil.isNullZeroString(wml140condition5__)
        ...
        //実行内容未選択
        if ((wml140actionLabel__ == null || !wml140actionLabel__.equals("1"))   // ラベルを付ける
         && (wml140actionRead__  == null || !wml140actionRead__.equals("1"))    // 既読にする
         && (wml140actionMove__  == null || !wml140actionMove__.equals(
                 String.valueOf(WML140_MOVEFOLDER_DO)))    // ゴミ箱に移動
         && (wml140actionSend__  == null || !wml140actionSend__.equals("1"))) { // アドレス 転送先 判定
            String msgKey = "error.select.required.text";
            ActionMessage msg = new ActionMessage(msgKey, getInterMessage(req, "wml.282"));
            StrutsUtil.addMessage(
                    errors, msg, "wml140execution." + msgKey);
        }
        ...
        //フォルダ移動選択チェック
        if (wml140actionMove__.equals(String.valueOf(WML140_MOVEFOLDER_DO))
                && !wml140actionFolderValue__.equals(
                        String.valueOf(GSConstWebmail.FILTER_MOVE_DUST))
                && !wml140actionFolderValue__.equals(
                        String.valueOf(GSConstWebmail.FILTER_MOVE_STRAGE))
                ) {
            String msgKey = "error.select.required.text";
            ActionMessage msg = new ActionMessage(msgKey,
                    getInterMessage(req, "cmn.folder"));
            StrutsUtil.addMessage(
                    errors, msg, "wml140selLabel." + msgKey);
        }
    ...
    public int conditionCheck(String condition,
        ...
        //条件
        if (!StringUtil.isNullZeroString(condition)) {
    ...
    /**
     * <p>wml140actionMove を取得します。
     * @return wml140actionMove
     */
    public String getWml140actionMove() {
        return wml140actionMove__;
    }

    /**
     * <p>wml140actionMove をセットします。
     * @param wml140actionMove wml140actionMove
     */
    public void setWml140actionMove(String wml140actionMove) {
        wml140actionMove__ = wml140actionMove;
    }

    /**
     * <p>wml140actionFolderValue を取得します。
     * @return wml140actionFolderValue
     * @see jp.groupsession.v2.wml.wml140.Wml140Form#wml140actionFolderValue__
     */
    public String getWml140actionFolderValue() {
        return wml140actionFolderValue__;
    }


    /**
     * <p>wml140actionFolderValue をセットします。
     * @param wml140actionFolderValue wml140actionFolderValue
     * @see jp.groupsession.v2.wml.wml140.Wml140Form#wml140actionFolderValue__
     */
    public void setWml140actionFolderValue(String wml140actionFolderValue) {
        wml140actionFolderValue__ = wml140actionFolderValue;
    }
