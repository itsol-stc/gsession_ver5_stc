...
public class Wml230Form extends Wml220Form {
    ...
    /** 動作 フォルダに移動する */
    private String wml230actionMove__ = "0";
    /** 選択 フォルダ */
    private String wml230actionFolderValue__ = String.valueOf(Wml140Form.WML140_MOVEFOLDER_DO);
    /** アドレス 転送先 判定*/
    ...
    public ActionErrors validateCheck(HttpServletRequest req, Connection con) throws Exception {
        ...
        //条件未選択
        if (StringUtil.isNullZeroString(wml230condition1__)
         && StringUtil.isNullZeroString(wml230condition2__)
         && StringUtil.isNullZeroString(wml230condition3__)
         && StringUtil.isNullZeroString(wml230condition4__)
         && StringUtil.isNullZeroString(wml230condition5__)
        ...
        //実行内容未選択
        if ((wml230actionLabel__ == null || !wml230actionLabel__.equals("1"))   // ラベルを付ける
         && (wml230actionRead__  == null || !wml230actionRead__.equals("1"))    // 既読にする
         && (wml230actionMove__  == null || !wml230actionMove__.equals(
                 String.valueOf(Wml140Form.WML140_MOVEFOLDER_DO)))    // ゴミ箱に移動
         && (wml230actionSend__  == null || !wml230actionSend__.equals("1"))) { // アドレス 転送先 判定
            String msgKey = "error.select.required.text";
            ActionMessage msg = new ActionMessage(msgKey, getInterMessage(req, "wml.282"));
            StrutsUtil.addMessage(
                    errors, msg, "wml230execution." + msgKey);
        }
        ...
        //フォルダ移動選択チェック
        if (wml230actionMove__.equals(String.valueOf(Wml140Form.WML140_MOVEFOLDER_DO))
                && !wml230actionFolderValue__.equals(
            ...
            StrutsUtil.addMessage(
                    errors, msg, "wml230selFolder." + msgKey);
        }
    ...
    /**
     * <p>wml230actionMove を取得します。
     * @return wml230actionMove
     */
    public String getWml230actionMove() {
        return wml230actionMove__;
    }

    /**
     * <p>wml230actionMove をセットします。
     * @param wml230actionMove wml230actionMove
     */
    public void setWml230actionMove(String wml230actionMove) {
        wml230actionMove__ = wml230actionMove;
    }

    /**
     * <p>wml230actionFolderValue を取得します。
     * @return wml230actionFolderValue
     * @see jp.groupsession.v2.wml.wml230.Wml230Form#wml230actionFolderValue__
     */
    public String getWml230actionFolderValue() {
        return wml230actionFolderValue__;
    }


    /**
     * <p>wml230actionFolderValue をセットします。
     * @param wml230actionFolderValue wml230actionFolderValue
     * @see jp.groupsession.v2.wml.wml230.Wml230Form#wml230actionFolderValue__
     */
    public void setWml230actionFolderValue(String wml230actionFolderValue) {
        wml230actionFolderValue__ = wml230actionFolderValue;
    }
