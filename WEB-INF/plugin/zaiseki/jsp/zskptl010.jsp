...
<table class="table-top w100 mb0">
  <tr>
    <th class="txt_l table_title-color w100">
      ...
      <a href="<bean:write name="zskptl010Form" property="zskTopUrl" />">
        <bean:write name="zskptl010Form" property="grpName" />
      </a>
    </th>
  </tr>
        ...
        <td>
          <div>
                ...
                <td class="main_zskProfArea">
                  ...
                  <logic:equal name="zskptl010Form" property="smailUseOk" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.PLUGIN_USE) %>">
                    <logic:equal name="userMdl" property="smlAble" value="1">
                      <a href="#" onClick="ptlmoveCreateMsg('msg', <bean:write name="userMdl" property="usrSid" />, '<%= zskFormId %>');">
                  ...
                  <logic:equal name="zskptl010Form" property="schUseOk" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.PLUGIN_USE) %>">
                    <logic:equal name="userMdl" property="schAccessFlg" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_ACCESS_YES) %>">
                      <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_DSP) %>">
                        <a href="#!" onClick="ptldispDescriptionZskOriginal('p<%= gsid %>ds<bean:write name="idx" />');">
                          <img class="btn_originalImg-display eventImg" id="resesSwitchp<%= gsid %>ds<bean:write name='idx' />" src="../zaiseki/images/original/icon_sch_not_dsp.png" alt="<gsmsg:write key="cmn.hide" />">
                        </a>
                      </logic:equal>
                      <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_NOT_DSP) %>">
                        <a href="#!" onClick="ptldispDescriptionZskOriginal('p<%= gsid %>ds<bean:write name="idx" />');">
                          <img class="btn_originalImg-display eventImg" id="resesSwitchp<%= gsid %>ds<bean:write name='idx' />" src="../zaiseki/images/original/icon_sch_dsp.png" alt="<gsmsg:write key="zsk.zskmaingrep.07" />">
                        </a>
                      </logic:equal>
                    </logic:equal>
                  </logic:equal>
            ...
            <logic:equal name="zskptl010Form" property="schUseOk" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.PLUGIN_USE) %>">
              <logic:equal name="userMdl" property="schAccessFlg" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_ACCESS_YES) %>">
                <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_DSP) %>">
                  <div id="p<bean:write name="zskptl010Form" property="dspGrpSid" />ds<bean:write name='idx' />" class="">
                </logic:equal>
                <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_NOT_DSP) %>">
                  <div id="p<bean:write name="zskptl010Form" property="dspGrpSid" />ds<bean:write name='idx' />" class="display_n">
                </logic:equal>
                <div class="main_zskSchedule lh140">
                  ...
                  <!-- スケジュール追加ボタン -->
                    <div class="txt_r">
                    <a href="#" onClick="return ptlzskaddSchedule('schw_add', <bean:write name="userMdl" property="usrSid" />, '<%= zskFormId %>');">
            ...
            <tr>
              ...
              <td class="txt_r p0">
                ...
                <logic:equal name="zskptl010Form" property="schUseOk" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.PLUGIN_USE) %>">
                  <logic:equal name="userMdl" property="schAccessFlg" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SCH_ACCESS_YES) %>">
                    <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_DSP) %>">
                      <a href="#!" onClick="ptldispDescriptionZsk('p<%= gsid %>ds<bean:write name="idx" />');">
                        <img class="btn_classicImg-display eventImg" id="resesSwitchp<%= gsid %>ds<bean:write name='idx' />" src="../zaiseki/images/classic/icon_sch_not_dsp.gif" alt="<gsmsg:write key="cmn.hide" />">
                      </a>
                    </logic:equal>
                    <logic:equal name="zskptl010Form" property="zaiSchViewDf" value="<%= String.valueOf(jp.groupsession.v2.zsk.GSConstZaiseki.MAIN_SCH_NOT_DSP) %>">
                      <a href="#!" onClick="ptldispDescriptionZsk('p<%= gsid %>ds<bean:write name="idx" />');">
                        <img class="btn_classicImg-display eventImg" id="resesSwitchp<%= gsid %>ds<bean:write name='idx' />" src="../zaiseki/images/classic/icon_sch_dsp.gif" alt="<gsmsg:write key="zsk.zskmaingrep.07" />">
                      </a>
                    </logic:equal>
                  </logic:equal>
                </logic:equal>
                ...
                <tr>
                  <td class="p0" colspan="3">
                    ...
                    <div class="main_zskSchedule lh140">
                      ...
                      <!-- スケジュール追加ボタン -->
                        <div class="txt_r">
                          <img class="btn_classImg-display eventImg cursor_p" src="../common/images/classic/icon_scadd.png" alt="<gsmsg:write key="cmn.add" />" onClick="return ptlzskaddSchedule('schw_add', <bean:write name="userMdl" property="usrSid" />, '<%= zskFormId %>');" />
                        </div>
                      </logic:equal>
                    </div>
                  </td>
