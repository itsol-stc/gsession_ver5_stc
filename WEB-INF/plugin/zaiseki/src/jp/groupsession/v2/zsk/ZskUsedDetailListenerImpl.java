 ...
 * <br>[解  説] 在席管理についての処理を行う
 * <br>[備  考]
 *
 * @author JTS
 */
public class ZskUsedDetailListenerImpl implements IUsedDetailListener {
    ...
    public Map<String, Long> getDatails(Connection con) throws SQLException {
        ...
        ZaiDatausedSumModel totalDataMdl = dataUsedDao.getTotalData();
        if (totalDataMdl != null) {
            detailMap.put("main.useddisk.zsk.zaseki", totalDataMdl.getZaiDataSize());
        }
