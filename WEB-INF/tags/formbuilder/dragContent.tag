<%@tag import="org.apache.commons.beanutils.BeanAccessLanguageException"%>
...
<%@ attribute description="プロパティ名 FormCell" name="property" type="java.lang.String"   rtexprvalue="true"%>
<%@ attribute description="要素ボディ" name="body" fragment="true" %>
<%@ attribute description="親要素 セレクタ 複数ドラッグアンドドロップがある場合の識別に使用" name="parentselecter" type="java.lang.String"   rtexprvalue="true"%>
...
<% String dragName = contentname;
  ...
  FormCell bean = (FormCell) jspContext.getAttribute("bean");
