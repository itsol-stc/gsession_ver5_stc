...
<common:loadscript src="../common/js/subform.js" patchVer="2" />
<common:loadscript src="../common/js/ui/sortingselector.js"  patchVer="2" />
<common:loadscript src="../common/js/ui/multiselector_search.js"  patchVer="2" />
<common:loadscript src="../common/js/overlapscroll.js" patchVer="2" />
<common:loadscript src="../common/js/userpopup.js"  patchVer="2" />


<bean:define id="thisFrom" name="<%=name %>" />

<bean:define id="subformParam">
  {name:'selectorDispCmd', value:'init'},
  {name:'targetSelector', value:'<%=property %>'},
  {name:'formClsName', value:'<%=thisFrom.getClass().getName() %>'},
  <logic:notEmpty name="ui" property="selectTargetKey">
    {name:'<%=property %>.selectTargetKey', value:'<%=ui.getSelectTargetKey() %>'},
  </logic:notEmpty>
</bean:define>
<fieldset class="<%=styleClass %>" name="<%=property %>" data-sortingselector_init="{
