...
<bean:define id="noselectBody">
  <logic:present name="ui" property="type">
    <logic:notEqual name="ui" property="type" value="<%=EnumSelectType.GROUP.name() %>">
          ...
          <td class="border_none p3 pb0 <%=childPr%>" colspan="<%=colspan%>" >
            ...
            >
              <input type="radio" name="nonselect" class=" display_none"
                ...
                onclick="$(this).ui_sortingselector({cmd:'select'}, arguments[0]);"
                 />
      ...
      <td class="border_none w100 p0">
        <div class="display_flex w100">
           <label class="verAlignMid">
             <input type="checkbox" name="sortingFlg" value="1"
               class="js_multiselector_sortingFlg"
               onchange="$(this).ui_sortingselector({cmd:'sortingChange'}, arguments[0]);"
               <logic:equal name="<%=name %>" property="sortingFlg" value="1">
                 checked
               </logic:equal>
             />
             <gsmsg:write key="cmn.sorting"/>
           </label>
           <logic:equal name="ui" property="useDetailSearch" value="true">
             <button class="ml_auto baseBtn userSelect_btn mt0" type="button" onclick="sortingselectorOpenSearchDialog(this);" value="<gsmsg:write key="cmn.advanced.search"/>">
        ...
        >
          <tr class="h100 border_none p0">
                ...
                <logic:notEmpty name="ui" property="selectMap" >
                  ...
                  <logic:iterate id="entry" name="ui" property="selectMap" indexId="index" type="Entry">
                    ...
                    <tr class="border_none w100 h30 p0 js_multiselector_select multiselector_select <%=selectedCls %>"
                          ...
                          onclick="$(this).ui_sortingselector({cmd:'selectorChange'}, arguments[0]);"
                    >
                      <td class="w100 border_none <%=selectPaddingCls%>">
                        <table class="bor1 w100 h100 bgC_header2 p0 multiselector_selectTbl js_multiselector_selectTbl pos_rel <%=selectOutlineCls %> "
                          >
                          <tr class="border_bottom_none w100 hp28 p0">
                            <th class="w100 p0 js_multiselector_selectHead pos_rel">
                              <div class="w100 p3 verAlignMid">
                                ...
                                <label class="textLink ml_auto verAlignMid">
                                  <button type="button" class="ml_auto display_none" href="#!" onclick="$(this).ui_sortingselector({cmd:'alldelete'}, arguments[0]);"></button>
                              ...
                              <fieldset class="w100 h100 js_multiselector_selected pos_rel ofy_a overlapscroll js_overlapscroll " data-subform_init="{
                                  ...
                                  <logic:notEmpty name="select" property="list" >
                                    <logic:iterate id="child" name="select" property="list" type="IChild">
                                      <label class=" js_multiselector_selectchild p3 pb0 display_flex pos_rel w100 pt3 pr6 cursor_p word_b-all content-hoverChange verAlignMid"
                                           onclick="$(this).ui_sortingselector({cmd:'selectedClick'}, arguments[0]);">
                                        ...
                                        <div class="mwp120 txt_l z_idx100 <bean:write name="deleteCls"/> <bean:write name="mukoCls"/>">
                                          <bean:write name="child" property="name"/>
                                        </div>
                                      </label>
                                    </logic:iterate>
            ...
            <td class="border_none <%=selectionWidthCls %> h100 p0">
              <table class="table-fixed bor1 w100 h100 p0 js_multiselector_selection pos_rel">
                <colgroup ><col class="w45 " /><col class="w55 " /></colgroup>
                <tr class="hp28  bgC_header2" >
                  <td class="w100 p0" colspan="2">
                    <div class="w100 p3 verAlignMid display_flex" >
                      ...
                      <label class="textLink ml_auto verAlignMid">
                        <button type="button" class="ml_auto display_none" href="#!" onclick="$(this).ui_sortingselector({cmd:'allselect'}, arguments[0]);"></button>
                ...
                <tr class="h100 border_none bgC_lightGray">
                    ...
                    <div class=" w100 h100 ofy_a js_multiselector_groupSelection overlapscroll js_overlapscroll ">
                      <logic:iterate id="group" name="ui" property="groupSelectionList" type="IChild">
                        ...
                        <div class="w100 word_b-all p3 pb0 pr6 js_multiselector_grpSelect verAlignMid display_flex <%=selectCls %>"
                          onclick="$(this).ui_sortingselector({cmd:'selectionChange'}, arguments[0]);">
                  ...
                  <td class=" p0 border_none hp100 mxwp300" <%=groupselnone %>>
                    <div class="w100 h100 js_multiselector_childSelection ofy_a overlapscroll js_overlapscroll bgC_tableCell">
                      <bean:define id="subformParam">
                      ...
                      <fieldset class="h100 js_multiselector_noselectbody pos_rel" data-subform_init="{
                          url:'../common/cmn370.do',
                          param:[
                            <bean:write name="subformParam" />
                              ],
