...
function loadingPop(nowDate, hashKey, count) {
    ...
    data.count = count;
    document.forms[0].rng070rngNowDate.value = nowDate;
    document.forms[0].rng070outPutDirHash.value = hashKey;
    ...
    $.ajax({
        ...
        if (distinctCount == 5 || data.errorFlg == "true") {
            ...
            if (data.pdfComplateFlg == "true") {
                ...
                $("#outputCount").html(data.count + msglist_rng070['cmn.number'] + " / " + json.count + msglist_rng070['cmn.number']);
                setTimeout(function() { pdfCheck(json, data.count); }, 3000);
            }
        }
    });
...
function pdfDownload() {
    ...
    document.forms[0].rng070rngNowDate.value = nowDate;
    document.forms[0].rng070outPutDirHash.value = outPutDirHash;
    nowDate = "";
    outPutDirHash = "";
    document.forms[0].submit();
    $('#loading_pop').dialog('close');
